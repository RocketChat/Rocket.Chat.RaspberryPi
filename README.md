...
* Next, perform `sudo apt-get update`  *BUT NOT*  `sudo apt-get dist-upgrade` !   It is important NOT to run `dist-upgrade` because the current version of 16.04LTS has a bug where you will end up losing network connection.
